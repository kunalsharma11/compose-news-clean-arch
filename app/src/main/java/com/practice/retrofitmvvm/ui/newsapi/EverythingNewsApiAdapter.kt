...
import com.practice.retrofitmvvm.databinding.TopHeadlineItemLayoutBinding

class EverythingNewsApiAdapter (
    private val articleList: ArrayList<Article>
): RecyclerView.Adapter<EverythingNewsApiAdapter.DataViewHolder>() {
